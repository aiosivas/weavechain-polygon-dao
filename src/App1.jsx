...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x90fb4f8DAAef60f8a273e733D7DF902b1c671eF8");
  const token = useToken("0x062390c170817a13F279242D31Ba17D9A59ce6A9");
  const vote = useVote("0x42A121cd02a721c41E4bbcEF9F4eafcbE0Cdb386");
  //const counter = await sdk.getContract("");
